...
define( 'CBLIB', '2.9.3' );	// IMPORTANT: when changing version here also change in cbInstallerPlugin.php, the 8 XML installation files and build.xml and just below
...
class CBLib
{
	protected static $THISCBVERSION		=	'2.9.3+build.2024.12.10.21.36.36.3f3ed9435';	 	// IMPORTANT: DO NOT CHANGE MANUALLY, but when changing version automatically here also change in cbInstallerPlugin.php, the 8 XML installation files and build.xml and just above
