 ...
 * Updated 2021-05-20 with Util::getParameterClassName() fix for PHP 8.0 from:
 * https://github.com/laravel/framework/blob/8.x/src/Illuminate/Container/Util.php#L51
 */
class Container implements ContainerInterface {
	 ...
	 * This method will be called automatically from the constructor of ObserverInterface
	 * which will be instantiated by ObserverMapper.
	...
	protected function getDependencies($parameters, array $primitives = array())
	{
		...
		{
			$dependency = static::getParameterClassName($parameter);
	...
	protected function resolveClass(ReflectionParameter $parameter)
	{
		try
		{
			return $this->make(static::getParameterClassName($parameter));
		}
